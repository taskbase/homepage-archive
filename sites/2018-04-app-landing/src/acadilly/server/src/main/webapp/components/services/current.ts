...
class Current {
  ...
  get permissions(): CoursePermissions {
    return this._permissions;
  }

  set permissions(value: CoursePermissions) {
  ...
  private _block: Task;
  private _tasks: Task[];
  private _permissions: CoursePermissions;
