...
// hand-transpiled from components/header/header-controller.ts.
// `Upload` (ng-file-upload) is injected by the era controller but never used;
// kept in the signature so the injector list matches the source.
angular.module('taskbaseApp')
  .controller('HeaderController',
    function($scope, $rootScope, $http, $state, Notify, Navigation, Login, $q, UserService
        , Utils, Permission, Upload, $timeout, Current,
             PermissionService, AppSettingsService
    ) {
