// hand-transpiled from components/filters/filters.ts -- defines the
// `taskbaseFilters` module that app.js lists as a dependency.
angular.module('taskbaseFilters', []).filter('translate', function(TranslationService) {
  ...
  return function(number, precision) {
    let fractionSizeString = (number + "").split(".")[1];
    let fractionSizeNumber;
